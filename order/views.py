    ...
    if request.user.is_authenticated:
        ...
        if carts.exists() and orders.exists():
            ...
            if coupon_form.is_valid():
                ...
                coupon_code_obj = Coupon.objects.get(code=code, active=True)
                if coupon_code_obj.valid_to >=current_time :
                    get_discount = (coupon_code_obj.discount / 100) * order.get_totals()
